...
class Client(InferenceClient):
    ...
    def infer(self, obs: dict, instruction: str) -> dict:
        ...
        if (
            ...
            self.actions_from_chunk_completed = 0
            request_data = {
                "observation/exterior_image_1_left": resize_with_pad(curr_obs["right_image"], 224, 224),
                "observation/wrist_image_left": resize_with_pad(curr_obs["wrist_image"], 224, 224),
